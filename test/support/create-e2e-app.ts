import { HttpStatus, Injectable, ValidationPipe, type CanActivate, type INestApplication } from '@nestjs/common';
...
const validationMessages: Partial<Record<ErrorCode, string>> = {
  [ERROR_CODES.INVALID_EMAIL_CODE_REQUEST_EMAIL]: '이메일 형식이 올바르지 않습니다.',
  ...
  [ERROR_CODES.MISSING_EMAIL_VERIFICATION_TOKEN]: '이메일 인증을 완료해주세요.',
  ...
  [ERROR_CODES.INVALID_PRODUCTS_LIMIT]: '상품 개수는 1 이상 100 이하의 숫자여야 합니다.',
  [ERROR_CODES.INVALID_SEARCH_STATUS]: '상품의 상태는 판매중, 예약중, 거래완료 중 하나여야 합니다.',
  [ERROR_CODES.INVALID_SEARCH_MIN_PRICE]: '최소 가격은 0 이상의 정수여야 합니다.',
  [ERROR_CODES.INVALID_SEARCH_MAX_PRICE]: '최대 가격은 0 이상의 정수여야 합니다.',
  [ERROR_CODES.MISSING_PRODUCT_TITLE]: '상품 제목은 필수입니다.',
  [ERROR_CODES.INVALID_PRODUCT_PRICE]: '상품 가격은 0 이상의 정수여야 합니다.',
  [ERROR_CODES.INVALID_PRODUCT_IMAGE_URLS]: '상품 이미지 형식이 올바르지 않습니다.',
  [ERROR_CODES.INVALID_PRODUCT_STATUS]: '상품 상태가 올바르지 않습니다.',
  [ERROR_CODES.INVALID_CHAT_MESSAGE]: '메시지 내용이 올바르지 않습니다.',
  [ERROR_CODES.INVALID_REFRESH_TOKEN]: '로그인 정보가 올바르지 않습니다. 다시 시도해주세요.',
};
